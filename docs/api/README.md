...
```
curl -X POST -d "flipper_id=user@user.com" http://example.com/flipper-api/api/v1/features/reports/actors
```
...
```
curl -X DELETE -d "flipper_id=user@user.com" http://example.com/flipper-api/api/v1/features/reports/actors
```
